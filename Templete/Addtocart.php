...
<head>
    <meta charset="utf-8">
    <title>BeautyZone Beauty Products HTML Template</title>
...
<body>
        ...
        <div class="row py-2 px-lg-5">
            <div class="col-lg-6 text-left mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center">
                    <small><i class="fa fa-phone-alt mr-2"></i>+91 7845839876</small>
                ...
                <div class="navbar-nav m-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu rounded-0 m-0">
                            <a href="Brush.php" class="dropdown-item">Brush</a>
                            <a href="Foundation.php" class="dropdown-item">Foundation</a>
                            <a href="Primer.php" class="dropdown-item">Primer</a>
                            <a href="Comapact.php" class="dropdown-item">Comapact</a>
							<a href="Concealer.php" class="dropdown-item">Concealer</a>
							<a href="Eyeliner.php" class="dropdown-item">Eyeliner</a>
							<a href="Eyeshadow.php" class="dropdown-item">Eyeshadow</a>
							<a href="Kajal.php" class="dropdown-item">Kajal</a>
							<a href="Loose Powder.php" class="dropdown-item">Loose Powder</a>
							<a href="Lipstic.php" class="dropdown-item">Lipstic</a>
							<a href="Mascara.php" class="dropdown-item">Mascara</a>
                        </div></div>
						 <div class="nav-item dropdown">
						...
						<a href="price.html" class="nav-item nav-link active">Add To Cart</a>
    ...
    <div class="jumbotron jumbotron-fluid bg-jumbotron" style="margin-bottom: 90px;">
        <div class="container text-center py-5">
            <h3 class="text-white display-3 mb-4">Add To Cart</h3>
    ...
    <div class="container-fluid py-5">
      ...
      <div class="col-lg-5" style="min-height: 500px;"> 
        <div class="position-relative h-100"> <img class="position-absolute w-100 h-100" src="../Client/image_project/bg10" style="object-fit: cover;"> 
        </div>
      </div>
                    ...
                    <div class="pricing-text bg-light p-4 p-lg-5 my-lg-5">
                        <div class="owl-carousel pricing-carousel">
                            <div class="bg-white">
                                ...
                                <div class="p-4">
                                    <p><i class="fa fa-check text-success mr-2"></i>Brush&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-check text-success mr-2"></i>Foundation</p>
                                    <p><i class="fa fa-check text-success mr-2"></i>Primer&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-check text-success mr-2"></i>Comapact</p>
                                    <p><i class="fa fa-check text-success mr-2"></i>Concealer&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-check text-success mr-2"></i>Eyeliner</p>
									 <p><i class="fa fa-check text-success mr-2"></i>Eyeshadow&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-check text-success mr-2"></i>Kajal</p>
									<p><i class="fa fa-check text-success mr-2"></i>Loose Powder&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-check text-success mr-2"></i>Lipstic</p>
						<p><i class="fa fa-check text-success mr-2"></i>Mascara</p>
    ...
    <div class="container-fluid py-5">
      ...
      <div class="col-lg-6" style="min-height: 500px;"> 
        <div class="position-relative h-100"> <img class="position-absolute w-100 h-100" src="img/opening.jpg" style="object-fit: cover;"> 
        </div>
      </div>
